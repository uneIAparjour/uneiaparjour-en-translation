...
- **Menus principal et pied de page** — un menu minimal **"Under construction – More coming soon"** a d'abord servi de placeholder le temps que les pages statiques soient traduites une à une (voir la section suivante) ; le placement définitif des liens dans le menu reste à faire.
...
Au-delà du pipeline d'articles quotidiens, les pages fixes du site et les mini-applications qui les accompagnent ont été traduites une à une, à la main — chacune a sa propre nature, aucun pipeline automatisé commun ne s'applique à ce groupe.
